...
int escolha;
    printf("____Escolha o atributo para comparar:____\n");
    printf("1. Populacao\n");
    printf("2. Area\n");
    printf("3. PIB\n");
    ...
    printf("\n____Resultado da Comparacao____\n");
    ...
    switch (escolha) {
        ...
        case 4:
            ...
            if (pontosTuristicos > pontosTuristicos2) printf("Vencedor: Carta 1 (%s)!\n", nomeCidade);
            else if (pontosTuristicos2 > pontosTuristicos) printf("Vencedor: Carta 2 (%s)!\n", nomeCidade2);
            else printf("Resultado: Empate!\n");
            break;
        case 5:
            printf("Atributo: Densidade Populacional (menor vence)\n");
            if (densidadePopulacional < densidadePopulacional2) printf("Vencedor: Carta 1 (%s)!\n", nomeCidade);
            else if (densidadePopulacional2 < densidadePopulacional) printf("Vencedor: Carta 2 (%s)!\n", nomeCidade2);
            else printf("Resultado: Empate!\n");
            break;
        case 6:
